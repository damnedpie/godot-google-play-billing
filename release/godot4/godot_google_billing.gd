...
func initialize() -> void:
	if Engine.has_singleton("GodotGooglePlayBilling"):
		...
		_gbilling.connect("connected", Callable(self, "_on_connected"))
		_gbilling.connect("disconnected", Callable(self, "_on_disconnected"))
		_gbilling.connect("billing_resume", Callable(self, "_on_billing_resume"))
		_gbilling.connect("connect_error", Callable(self, "_on_connect_error"))
		_gbilling.connect("purchases_updated", Callable(self, "_on_purchases_updated"))
		_gbilling.connect("query_purchases_response", Callable(self, "_on_query_purchases_response"))
		_gbilling.connect("purchase_error", Callable(self, "_on_purchase_error"))
		_gbilling.connect("sku_details_query_completed", Callable(self, "_on_sku_details_query_completed"))
		_gbilling.connect("sku_details_query_error", Callable(self, "_on_sku_details_query_error"))
		_gbilling.connect("price_change_acknowledged", Callable(self, "_on_price_change_acknowledged"))
		_gbilling.connect("purchase_acknowledged", Callable(self, "_on_purchase_acknowledged"))
		_gbilling.connect("purchase_acknowledgement_error", Callable(self, "_on_purchase_acknowledgement_error"))
		_gbilling.connect("purchase_consumed", Callable(self, "_on_purchase_consumed"))
		_gbilling.connect("purchase_consumption_error", Callable(self, "_on_purchase_consumption_error"))
